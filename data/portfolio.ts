...
`,
  ...
  certifications: [
    ...
    },
    {
      ...
      institution: "Alura",
      date: "out de 2025",
      details: "Formação completa em Java e Orientação a Objetos.",
    },
    {
      name: "Formação Java e Orientação a Objetos G9 - ONE",
      institution: "Alura",
      date: "out de 2025",
      details: "Parte do programa Oracle Next Education (ONE).",
    },
    {
      name: "Frontend Developer (React)",
      institution: "HackerRank",
      date: "set de 2025",
      details: "Competências: React.js, CSS, JavaScript.",
    },
    {
      name: "Software Engineer",
      institution: "HackerRank",
      date: "set de 2025",
      details: "Competências: Problem solving, SQL, API REST.",
    },
    {
      name: "GFT - Desenvolvimento Java com IA",
      institution: "DIO",
      date: "ago de 2025",
      details: "Competências: Java, Inteligência artificial, Spring Boot, SQL, Git, GitHub, IA generativa.",
    },
    {
      name: "Formação Iniciante em Programação G9 - ONE",
      institution: "Alura",
      date: "ago de 2025",
      details: "Parte do programa Oracle Next Education (ONE).",
    },
    {
      name: "Formação Desenvolvimento Pessoal G9 - ONE",
      institution: "Alura",
      date: "jul de 2025",
      details: "Parte do programa Oracle Next Education (ONE).",
    },
    {
      name: "Imersão Inteligência Artificial 2ª Edição",
      institution: "Alura",
      date: "jun de 2025",
      details: "Foco em conceitos e aplicações de IA.",
    },
    {
      name: "Java (Basic)",
      institution: "HackerRank",
      date: "jun de 2024",
      details: "Tópicos básicos em Java: classes, estruturas de dados, herança, tratamento de exceções.",
    },
    {
      name: "BOOTCAMP NEGÓCIOS DO FUTURO",
      institution: "Sebrae",
      date: "abr de 2024",
      details: "Competências: Desenvolvimento de produtos e serviços, Ferramentas para sustentação.",
    },
    {
      name: "Decola Tech 2024",
      institution: "DIO",
      date: "jan de 2024",
      details: "Competências: C#, .NET, POO, GitHub, Git.",
    },
    {
      name: "Desenvolvimento Frontend com Angular",
      institution: "DIO",
      date: "jan de 2024",
      details: "Competências: JavaScript, TypeScript, HTML, CSS, Angular.",
    },
    {
      name: "Formação ChatGPT for Devs",
      institution: "DIO",
      date: "ago de 2023",
      details: "Competências: ChatGPT, Engenharia de Prompt, OpenAI API, IA generativa.",
    },
    {
      name: "Potência Tech Angular Developer - Powered by iFood",
      institution: "DIO",
      date: "mai de 2023",
      details: "Competências: Angular, CSS, TypeScript, JavaScript, HTML.",
    },
    {
      name: "Fortaleza dos CodeMiners",
      institution: "DIO",
      date: "mai de 2023",
      details: "Competências: C/C++.",
    },
    {
      name: "ITIL® 4 Foundation",
      institution: "AXELOS Global Best Practice",
      date: "2023",
      details: "Gerenciamento de serviços de TI (ITSM) e melhores práticas para entrega de valor.",
    },
    {
      name: "LGPD - Lei Geral de Proteção de Dados",
      institution: "Alura",
      date: "2023",
      details: "Conceitos e aplicação da Lei Geral de Proteção de Dados no desenvolvimento de software.",
    },
    {
      name: "Visão Geral do ITIL4",
      institution: "Ka Solution",
      date: "jul de 2022",
      details: "Visão geral sobre o framework ITIL 4.",
    },
    {
      name: "DPO & LGPD na Prática",
      institution: "Ka Solution",
      date: "mai de 2022",
      details: "Foco prático em Data Protection Officer (DPO) e Lei Geral de Proteção de Dados (LGPD).",
    },
    {
      name: "Spring React",
      institution: "DevSuperior",
      date: "mai de 2022",
      details: "Desenvolvimento full-stack com Spring Boot e React.",
    },
    {
      name: "Microsoft Azure Fundamentals (AZ-900)",
      institution: "Ka Solution",
      date: "fev de 2022",
      details: "Fundamentos da plataforma de nuvem Microsoft Azure.",
    },
    {
      name: "SCRUM Overview",
      institution: "Ka Solution",
      date: "fev de 2022",
      details: "Visão geral da metodologia Scrum.",
    },
    {
      name: "Introdução ao Entity Framework Core",
      institution: "desenvolvedor.io",
      date: "mar de 2022",
      details: "Introdução ao ORM Entity Framework Core.",
    },
    {
      name: "Iniciando com ASP.NET Core",
      institution: "desenvolvedor.io",
      date: "fev de 2022",
      details: "Primeiros passos com o framework ASP.NET Core.",
    },
  ],
  languages: [

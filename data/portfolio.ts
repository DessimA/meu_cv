...
export const portfolioData: PortfolioData = {
  ...
  skills: [
    ...
    { name: "Next.js", category: "Frameworks & Bibliotecas" },
    { name: "Tailwind CSS", category: "Frameworks & Bibliotecas" },
    { name: "Framer Motion", category: "Frameworks & Bibliotecas" },
    { name: "Zod", category: "Frameworks & Bibliotecas" },
    { name: "React Hook Form", category: "Frameworks & Bibliotecas" },
    { name: "Lucide React", category: "Frameworks & Bibliotecas" },
    { name: "GitHub Actions", category: "Cloud & DevOps" },
    { name: "GitHub Pages", category: "Cloud & DevOps" },
    { name: "CI/CD", category: "Cloud & DevOps" },
    { name: "Gerenciamento de Segredos", category: "Cloud & DevOps" },
    { name: "Design Responsivo", category: "Metodologias & Conceitos" },
    { name: "Componentização", category: "Metodologias & Conceitos" },
    { name: "Gerenciamento de Estado (Zustand)", category: "Metodologias & Conceitos" },
    { name: "Static Site Generation (SSG)", category: "Metodologias & Conceitos" },
